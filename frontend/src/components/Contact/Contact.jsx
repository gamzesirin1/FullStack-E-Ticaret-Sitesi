			...
			<div className="contact-bottom">
				<div className="container">
					<div className="contact-titles">
						...
						<h2>Get In Touch</h2>
						<p>
							In hac habitasse platea dictumst. Pellentesque viverra sem nec orci lacinia, in bibendum urna mollis.
					...
					<div className="contact-elements">
						<form className="contact-form">
							...
							<div className>
								...
								<textarea id="author" name="author" type="text" size={30} required defaultValue={''} />
							</div>
